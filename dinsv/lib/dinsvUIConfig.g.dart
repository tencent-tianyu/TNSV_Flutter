...
part of 'dinsvUIConfig.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

DinsvUIConfig _$DinsvUIConfigFromJson(Map<String, dynamic> json) {
  return DinsvUIConfig()
    ..ios = DinsvUIConfigIOS.fromJson(json['ios'] as Map<String, dynamic>)
    ..androidPortrait = DinsvUIConfigAndroid.fromJson(
        json['androidPortrait'] as Map<String, dynamic>)
    ..androidLandscape = DinsvUIConfigAndroid.fromJson(
        json['androidLandscape'] as Map<String, dynamic>);
}

Map<String, dynamic> _$DinsvUIConfigToJson(DinsvUIConfig instance) =>
    <String, dynamic>{
...
DinsvUIConfigIOS _$DinsvUIConfigIOSFromJson(Map<String, dynamic> json) {
  return DinsvUIConfigIOS()
    ...
    ..widgets = (json['widgets'] as List<dynamic>?)
        ?.map((e) => DinsvCustomWidgetIOS.fromJson(e as Map<String, dynamic>))
        .toList()
    ...
    ..layOutPortrait = DinsvOrientationLayOutIOS.fromJson(
        json['layOutPortrait'] as Map<String, dynamic>)
    ..layOutLandscape = DinsvOrientationLayOutIOS.fromJson(
        json['layOutLandscape'] as Map<String, dynamic>);
}

Map<String, dynamic> _$DinsvUIConfigIOSToJson(DinsvUIConfigIOS instance) {
...
DinsvOrientationLayOutIOS _$DinsvOrientationLayOutIOSFromJson(
    Map<String, dynamic> json) {
  return DinsvOrientationLayOutIOS()
...
Map<String, dynamic> _$DinsvOrientationLayOutIOSToJson(
    DinsvOrientationLayOutIOS instance) {
  final val = <String, dynamic>{};
...
DinsvUIConfigAndroid _$DinsvUIConfigAndroidFromJson(Map<String, dynamic> json) {
  return DinsvUIConfigAndroid(
    isFinish: json['isFinish'] as bool,
  )
    ..setAuthBGImgPath = json['setAuthBGImgPath'] as String?
    ...
    ..widgetLayouts = (json['widgetLayouts'] as List<dynamic>?)
        ?.map(
            (e) => DinsvCustomWidgetLayout.fromJson(e as Map<String, dynamic>))
        .toList()
    ..widgets = (json['widgets'] as List<dynamic>?)
        ?.map((e) => DinsvCustomWidget.fromJson(e as Map<String, dynamic>))
        .toList();
}

Map<String, dynamic> _$DinsvUIConfigAndroidToJson(
    DinsvUIConfigAndroid instance) {
  final val = <String, dynamic>{
...
DinsvCustomWidgetLayout _$DinsvCustomWidgetLayoutFromJson(
    Map<String, dynamic> json) {
  return DinsvCustomWidgetLayout(
    json['widgetLayoutName'] as String,
    _$enumDecode(_$DinsvCustomWidgetLayoutTypeEnumMap, json['type']),
  )
...
Map<String, dynamic> _$DinsvCustomWidgetLayoutToJson(
        DinsvCustomWidgetLayout instance) =>
    <String, dynamic>{
      ...
      'type': _$DinsvCustomWidgetLayoutTypeEnumMap[instance.type],
    };

const _$DinsvCustomWidgetLayoutTypeEnumMap = {
  DinsvCustomWidgetLayoutType.RelativeLayout: 'RelativeLayout',
};

DinsvCustomWidget _$DinsvCustomWidgetFromJson(Map<String, dynamic> json) {
  return DinsvCustomWidget(
    json['widgetId'] as String,
    _$enumDecodeNullable(_$DinsvCustomWidgetTypeEnumMap, json['type']),
  )
    ..left = json['left'] as int
    ..top = json['top'] as int
    ..right = json['right'] as int
    ...
    ..textAlignment = _$enumDecode(
        _$DinsvCustomWidgetGravityTypeEnumMap, json['textAlignment'])
    ..isFinish = json['isFinish'] as bool;
}

Map<String, dynamic> _$DinsvCustomWidgetToJson(DinsvCustomWidget instance) {
  final val = <String, dynamic>{
  ...
  val['textAlignment'] =
      _$DinsvCustomWidgetGravityTypeEnumMap[instance.textAlignment];
  writeNotNull('type', _$DinsvCustomWidgetTypeEnumMap[instance.type]);
  val['isFinish'] = instance.isFinish;
  return val;
}

const _$DinsvCustomWidgetTypeEnumMap = {
  DinsvCustomWidgetType.TextView: 'TextView',
  DinsvCustomWidgetType.Button: 'Button',
  DinsvCustomWidgetType.ImageView: 'ImageView',
};

const _$DinsvCustomWidgetGravityTypeEnumMap = {
  DinsvCustomWidgetGravityType.left: 'left',
  DinsvCustomWidgetGravityType.right: 'right',
  DinsvCustomWidgetGravityType.center: 'center',
};

DinsvCustomWidgetIOS _$DinsvCustomWidgetIOSFromJson(Map<String, dynamic> json) {
  return DinsvCustomWidgetIOS(
    json['widgetId'] as String,
    _$enumDecodeNullable(_$DinsvCustomWidgetTypeEnumMap, json['type']),
  )
    ...
    ..navPosition = _$enumDecodeNullable(
        _$DinsvCustomWidgetiOSNavPositionEnumMap, json['navPosition'])
    ..isFinish = json['isFinish'] as bool;
}

Map<String, dynamic> _$DinsvCustomWidgetIOSToJson(
    DinsvCustomWidgetIOS instance) {
  final val = <String, dynamic>{
    'widgetId': instance.widgetId,
  };
  ...
  writeNotNull('navPosition',
      _$DinsvCustomWidgetiOSNavPositionEnumMap[instance.navPosition]);
  val['isFinish'] = instance.isFinish;
  return val;
}

const _$DinsvCustomWidgetiOSNavPositionEnumMap = {
  DinsvCustomWidgetiOSNavPosition.navleft: 'navleft',
  DinsvCustomWidgetiOSNavPosition.navright: 'navright',
};
