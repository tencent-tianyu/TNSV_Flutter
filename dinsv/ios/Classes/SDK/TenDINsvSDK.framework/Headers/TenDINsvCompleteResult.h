...
@class TenDINsvCompleteResult;
typedef void(^TenDINsvComplete)(TenDINsvCompleteResult * completeResult);

@interface TenDINsvCompleteResult : NSObject
...
/// 累计上报 （为1则累计上报）
@property (nonatomic,assign)NSInteger tenDINsvReportTag;

+(instancetype)tenDINsv_CompleteWithCode:(NSInteger)code message:(NSString *)message data:(nullable NSDictionary *)data  error:(nullable NSError *)error;
