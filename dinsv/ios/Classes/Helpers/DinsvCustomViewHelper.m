//
//  DinsvCustomViewCongifure.m
//  DinsvCustomViewCongifure
//
...
@implementation DinsvCustomViewCongifure
-(void)dealloc{
    NSLog(@"%s",__func__);
}
...
@implementation DinsvCustomViewHelper
+(UIButton*)customButtonWithCongifure:(DinsvCustomViewCongifure *)customButtonCongifure{
...
+(UILabel*)customLabelWithCongifure:(DinsvCustomViewCongifure *)customLabelCongifure{
...
+(UIImageView*)customImageViewWithCongifure:(DinsvCustomViewCongifure *)customImageViewCongifure{
