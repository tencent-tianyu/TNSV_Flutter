...
-keep  class com.tencent.tendinsv.OneKeyLoginManager{
    public  *;
}
-keep  class com.tencent.tendinsv.tool.ShanYanUIConfig{
    public  *;
}
-keep  class com.tencent.tendinsv.tool.CheckAuthTool{
    public  *;
}
-keep  class com.tencent.tendinsv.tool.CLCustomViewSetting{
    public  *;
}
-keepclasseswithmembers class com.tencent.tendinsv.tool.ShanYanUIConfig$Builder{
      <methods>;
}
-keep  class com.tencent.tendinsv.listener.**{
    public  *;
}
